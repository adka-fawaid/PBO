package id.my.adkafawaid.moduls.Data;

import id.my.adkafawaid.moduls.Encryptor.Encryptor;
...
public class PasswordStore {
    ...
    public static int getUncategorized() {
        return UNCATEGORIZED;
    }

    public static int getCatWebapp() {
        return CAT_WEBAPP;
    }

    public static int getCatMobileapp() {
        return CAT_MOBILEAPP;
    }

    public static int getCatOther() {
        return CAT_OTHER;
    }
